...
namespace StratedgemeMonitor.AspNetCore.Controllers
{
    public class ExecutionsControllerUtils
    {
        ...
        private static ExecutionsControllerUtils instance;

        public static ExecutionsControllerUtils GetInstance(BackendExecutionsConnector connector)
        {
            if (instance == null)
                instance = new ExecutionsControllerUtils(connector);

            return instance;
        }

        private ExecutionsControllerUtils(BackendExecutionsConnector connector)
        {
